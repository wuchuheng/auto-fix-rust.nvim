...
function M.autofixRust()
  vim.api.nvim_create_autocmd("BufWritePre", {
    ...
    callback = function()
      ...
      local output = vim.fn.system("cargo fix --allow-dirty", project_root)
      ...
      for _, line in ipairs(newOutputList) do
        ...
        local modified_line_content = line_content:sub(1, column_number - 1) .. ";" .. line_content:sub(column_number)
